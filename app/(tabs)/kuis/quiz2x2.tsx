...
import { det2x2, generateRandomMatrix, roundTo } from '@/utils/determinant';
...
export default function Quiz2x2() {
    ...
    const startQuiz = useCallback(() => {
        const mat = generateRandomMatrix(2, -10, 10);
        setMatrix(mat);
        setCorrectAnswer(det2x2(mat[0][0], mat[0][1], mat[1][0], mat[1][1]));
        setAnswer('');
            ...
            <View className="flex-1 px-5 pt-4">
                ...
                <View className="flex-row items-center justify-between mb-6">
                    <View className="flex-row items-center">
                        <TouchableOpacity
                            ...
                            className="w-10 h-10 rounded-xl bg-surface-card border border-amber-500/20 items-center justify-center mr-3"
                        >
                            <ArrowLeft size={20} color="#fbbf24" />
                        </TouchableOpacity>
                        <Text className="text-xl font-extrabold text-white">Kuis 2×2</Text>
                    </View>
                ...
                {matrix.length > 0 && !isSubmitted && (
                    <View className="bg-surface-card border border-amber-500/15 rounded-3xl p-5 mb-5">
                        <Text className="text-amber-300 font-bold text-base mb-2 text-center">
                            Hitung Determinan Matriks Berikut:
                        </Text>
                        <MatrixDisplay matrix={matrix} size={2} />
                        ...
                        <TouchableOpacity
                            ...
                            className="mt-4"
                        >
                            <View className="bg-amber-600 rounded-2xl py-4 items-center">
